...
for run_index = 1:num_runs
    ...
    for i = 1:count_iter
        ...
        min_dis2medoid_overIntraDis(run_index, i) = min_dis2medoid(i) / min_avgIntraDis;
        min_dis2strongestHub_overIntraDis(run_index, i) = min_dis2strongestHub / min_avgIntraDis;
        max_dis2medoid_overIntraDis(run_index, i) = max_dis2medoid(i) / max_avgIntraDis;
        max_dis2strongestHub_overIntraDis(run_index, i) = max_dis2strongestHub / max_avgIntraDis;
    end
end
...
print('-f1', sprintf('part1-synData/dim%d_avg_min', dim), '-dpng');
...
grid on;                                           % add grid lines
legend('dis2medoid', 'dis2strongestHub');
print('-f2', sprintf('part1-synData/dim%d_avg_max', dim), '-dpng');
close all;
